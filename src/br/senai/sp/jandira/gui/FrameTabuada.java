...
public class FrameTabuada {
	...
	public void criarTela() {
		...
		labelMultiplicando.setBounds(83, 90, 100, 60);
		...
		textMultiplicando.setBounds(190, 98, 150, 30);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (textMultiplicando.getText().isEmpty() || textMinMultiplicador.getText().isEmpty()
					...
					if (tabuada.maxMultiplicador <= tabuada.minMultiplicador) {
						JOptionPane.showMessageDialog(null, "Digite um valor menor do que o máximo multiplicador",
